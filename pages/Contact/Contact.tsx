...
const Contact: React.FC = () => {
  ...
  return (
    <div className="bg-white font-plus-jakarta selection:bg-green-100 selection:text-green-900 overflow-x-hidden relative min-h-screen">
      ...
      <section className="bg-[#0f172a] pt-24 pb-20 text-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <p className="text-center text-gray-400 max-w-2xl mx-auto font-medium">
            Connect with us to discuss your project requirements, ask questions,
            or learn more about how we can support your business growth.
          </p>
        </div>
      </section>
      ...
      <div className="relative overflow-hidden pt-20 pb-32">
        ...
        <div
          className="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/4 w-[500px] h-[500px] bg-emerald-50 rounded-full blur-[100px] opacity-60 pointer-events-none animate-pulse"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            ...
            <div className="space-y-12">
              <div className="space-y-6">
                ...
                <h2 className="text-4xl sm:text-5xl font-black text-gray-black leading-[1.1] tracking-tight">
                ...
                <p className="text-lg sm:text-xl text-gray-600 max-w-xl leading-relaxed">
                  Ready to transform your brand? Our experts are here to help
                  you scale with data-driven marketing strategies and high-end
                  design.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {[
                  ...
                  <div
                    key={idx}
                    className={`group relative p-8 bg-white/40 backdrop-blur-md border border-green-200 rounded-[1.5rem] ${item.border} hover:shadow-[0_20px_50px_rgba(0,0,0,0.05)] hover:border-green-300 transition-all duration-500 overflow-hidden`}
                  >
                    {/* Hover Background Glow */}
                    <div
                      className={`absolute -right-10 -top-10 w-32 h-32 ${item.bg} rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700`}
                    />

                    <div className="relative z-10">
                      <div
                        className={`${item.bg} ${item.color} w-16 h-16 rounded-[1.25rem] flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-[10deg] transition-all duration-500 shadow-sm`}
                      >
                        <item.icon className="w-8 h-8" />
                      </div>
                      <h5 className="font-extrabold text-gray-900 text-xl mb-2 tracking-tight">
                        {item.title}
                      </h5>
            ...
            <div className="relative lg:sticky lg:top-32">
              ...
              <div className="bg-white p-4 sm:p-12 rounded-[1.5rem] shadow-[0_40px_80px_-20px_rgba(0,0,0,0.08)] border border-gray-100 relative overflow-hidden">
                {status === "success" ? (
                  <div className="text-center py-16">
                    ...
                    <h4 className="text-3xl text-gray-900 font-black mb-4">
                      Message Sent!
                    </h4>
                    <p className="text-gray-500 mb-10 max-w-xs mx-auto text-lg">
                      We've received your inquiry. Expect a response within 24
                      business hours.
                    </p>
                    <button
                  ...
                  <div className="space-y-10">
                    <div className="space-y-3">
                      ...
                      <p className="text-gray-500 font-medium">
                        Have a question or idea? We'd love to connect.
                      </p>
                    </div>
        ...
        <div className="mx-auto relative group">
          ...
          <div className="relative overflow-hidden shadow-2xl border-white h-[500px]">
            ...
            <div className="absolute bottom-8 left-8 bg-white/90 backdrop-blur-md p-6 rounded-3xl shadow-2xl border border-white/50 max-w-xs hidden md:block">
              <h6 className="font-black text-gray-900 mb-2">
                Visit Our Creative Space
              </h6>
              <p className="text-sm text-gray-600 leading-relaxed">
                South Banasree, Road 12, House 26, Dhaka. We're open Mon-Fri,
                10am - 7pm.
              </p>
            </div>
          </div>
