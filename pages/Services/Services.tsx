...
const Services: React.FC = () => {
  ...
  return (
    <div className="bg-white min-h-screen font-sans selection:bg-green-100 selection:text-green-900">
      {/* Cinematic Dark Hero with Texture */}
      <section className="bg-[#030712] pt-10 pb-12 text-center relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-6xl font-black text-white mb-8 leading-[1.1] tracking-tight animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-100">
